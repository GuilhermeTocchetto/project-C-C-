...
do{
	cout<<"quantos valores vc dejesa digitar(maximo):";
	cin>>q;
}while(q<20);



	cout<<"digite uma lista com "<<q<<" para calcular a média/n/n";
	...
	cout<<"/n média dos valores = "<<m<<"/n/n";
	...
	else cout<<"O valor nao se encontra na lista/n/n";
	system("pause");
